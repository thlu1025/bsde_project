# -*- coding: utf-8 -*-
"""
Created on Fri Nov  1 15:03:00 2019
...
class FeedForwardModel(object):
    ...
    def __init__(self, config, bsde, sess):
        ...
        self._fnetwork_structure = [self._dim, self._dim+10, self._dim+10,self._dim+10, self._dim]
    ...
    def train(self):
        ...
        for step in range(self._config.num_iterations+1):
            if step % self._config.logging_frequency == 0:
                loss, graphs = self._sess.run([self._loss, self.graphs,
    ...
    def build(self):
        ...
        with tf.variable_scope('forward'):
            ...
            l = []
            for i in range(82):
                l.append(self._fnetwork(self.x[:, i], 'f_layer'))
